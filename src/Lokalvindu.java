...
public class Lokalvindu extends JApplet {
	...
	private void addSpecificC(String l) {
		if (l.equals("Kino")) {
			north.setLayout(new GridLayout(5, 2)); // 5 rows 2 columns; no gaps);
			...
			north.setLayout(new GridLayout(6, 2)); // 6 rows 2 columns; no gaps);
			...
			north.setLayout(new GridLayout(5, 1)); // 5 rows 2 columns; no gaps);
